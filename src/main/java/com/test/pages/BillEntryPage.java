...
public class BillEntryPage {
	...
	public void inputTextIntoPOS(String POS){
		Functions.inputText(driver, silverInputBoxes.get(0), POS);
	}

	public void inputTextIntoTOS(String TOS){
		Functions.inputText(driver, silverInputBoxes.get(1), TOS);
	}

	public void inputTextIntoBillCd(String BillCd){
		Functions.inputText(driver, silverInputBoxes.get(8), BillCd);
	}

	public void inputTextIntoBillMd(String BillMd){
		Functions.inputText(driver, silverInputBoxes.get(9), BillMd);
	}

	public void inputTextIntoRevCd(String RevCd){
		Functions.inputText(driver, silverInputBoxes.get(10), RevCd);
	}

	public void inputTextIntoRevMd(String RevMd){
		Functions.inputText(driver, silverInputBoxes.get(11), RevMd);
	}

	public void inputTextIntoCMSDays(String Days){
		Functions.inputText(driver, numBoxList.get(5), Days);
	}

	public void inputTextIntoChrgs(String  Chrgs){
		Functions.inputText(driver, numBoxList.get(6), Chrgs);
	}
	...
	public void inputTextIntoDiag(String Diag){
		Functions.inputText(driver, silverInputBoxes.get(12), Diag);
	}
	...
	public void inputTextIntoBillRevenueCd(String BillRevenueCd){
		Functions.inputText(driver, silverInputBoxes.get(5), BillRevenueCd);
	}

	public void inputTextIntoReviewedCd(String ReviewedCd){
		Functions.inputText(driver, silverInputBoxes.get(6), ReviewedCd);
	}

	public void inputTextIntoMod(String Mod){
		Functions.inputText(driver, silverInputBoxes.get(7), Mod);
	}

	public void inputTextIntoUB04Days(String Days){
